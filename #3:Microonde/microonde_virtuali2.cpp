...
int main(int argc, char *argv[]){
    ...
    ifstream file_dati;
    file_dati.open("dati_virtuali2.txt", ios::in );
    ...
    TGraphErrors *ge1 = new  TGraphErrors("dati_virtuali2.txt" , "%lg %lg 0.5 0.2"); 
    ...
    ge1->Fit("opzione1");
    c1->Print ("interpolazione_1_reale.png", "png");
    TFitResult results1;
    results1.Print();
    ...
    TGraph *ge2 = new  TGraph("dati_virtuali2.txt" , "%lg %lg 0.5 0.2"); 
    ...
    ge2->Fit("opzione2");
    c2->Print ("interpolazione_2_reale.png", "png");
    TFitResult results2;
    results2.Print();
    ...
    TGraph *ge3 = new  TGraph("dati_virtuali2.txt" , "%lg %lg 0.5 0.2"); 
    ...
    ge3->Fit("opzione3");
    c3->Print ("interpolazione_3_reale.png", "png");
    TFitResult results3;
    results3.Print();
